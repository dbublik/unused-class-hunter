...
namespace DBublik\UnusedClassHunter\Filter\Symfony;
...
{
    private const AUTOCONFIGURE_TAG_CLASS = 'Symfony\Component\DependencyInjection\Attribute\AutoconfigureTag';
    private const MAX_DEEP_DEFAULT = 3;
